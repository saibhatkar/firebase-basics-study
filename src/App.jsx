...
import FirebaseContextSignUp from "./pages/FirebaseContextSignUp";
...
function App() {
  ...
  return (
    <>
      ...
      <div className="firebaseContextSignUp">
        {/* Firebase Context Sign Up Component */}
        <FirebaseContextSignUp />
      </div>
    </>
  );
}
